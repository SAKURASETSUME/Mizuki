...
**ps:由于Vercel把国内墙了 你想要在国内访问的话最好是自己有个域名 把这个metingAPI的项目绑到自己的域名上**
...
**在Vercel创建项目的时候 Vercel会在你的github同步创建一个仓库 去找你的同名项目 在/src/providers/netease/utils.js文件 替换成如下代码：**
...
export const musicPlayerConfig: MusicPlayerConfig = {
	...
	meting_api:
		"https://meting.nakatsusizuru.top/api?server=:server&type=:type&id=:id&auth=:auth&r=:r", // Meting API 地址
	id: "2648052450", // 歌单ID
...
**如果想要测试接口是否有效 访问一下自己的接口域名 里面有测试链接**



**把api接口替换成你自己的接口(即使你的域名里面不带/api这个uri 你也要写上 这代表这串url是作为api使用的) id替换成你自己的歌单id就能正常使用了**



**文章参考来源:[Vercel部署Meting-API并添加网易云cookie | Klog](https://joking7.com/2024/06/21/博客相关/自建MetingJS-API并添加cookie/)**